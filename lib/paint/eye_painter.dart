...
class EyePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final eyeBounds = Rect.fromCircle(center: centerEye, radius: size.width/4);
    final eyeOuterBounds = Rect.fromCircle(center: centerEye, radius: size.width/3);
    final eyeInnerBounds = Rect.fromCircle(center: centerEye, radius: size.width/8);
    _drawBackground(canvas, shapeBounds, eyeBounds,eyeOuterBounds,eyeInnerBounds);

    }

  void _drawBackground(Canvas canvas, Rect shapeBounds, Rect eyeBounds,Rect eyeOuterBounds,Rect eyeInnerBounds) {
